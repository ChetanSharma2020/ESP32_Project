...
#define AUTH "Blynk Auth Token"                 // You should get Auth Token in the Blynk App pasate that tocken here  
#define WIFI_SSID "Wifi Name"             //Enter Wifi Name
#define WIFI_PASS "wifi Password"         //Enter your wifi Password
